...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Data Anggota DPRD</h1>
...
@section('scripts')
    $(function() {
        ...
        $(document).on('click','.edit',function (){
            var id = $(this).data('id');
            url = "{{ route('data-anggota-dprd.edit', ':id') }}";
        ...
        $(document).on('click','.delete',function (){
            ...
            Swal.fire({
                ...
                {
                    url = "{{ route('data-anggota-dprd.destroy', ':id') }}";
                    url = url.replace(':id', id);
                    $.ajax({
                        type    : 'DELETE',
                        url     : url,
        ...
        $('#ModalForm').submit(function(e) {
            ...
            $.ajax({
                type : 'POST',
                url: "{{ route('data-anggota-dprd.store')}}",
                data: formData,
                cache:false,
                contentType: false,
                processData: false,
